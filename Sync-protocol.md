إليك التوثيق الفني الكامل بصيغة Markdown، جاهز للنسخ والاستخدام في مستودع مشروعك (Repository) أو أي أداة توثيق.
...
بروتوكول LDPR هو نظام مزامنة بيانات موزع (Distributed Data Synchronization) مصمم لبيئات Local-First. يعتمد البروتوكول على "المنطق الحتمي" (Deterministic Logic) الموجود في الأجهزة الطرفية (Clients/Actors) بدلاً من الاعتماد على منطق مركزي في السيرفر.
المبادئ الأساسية:
...
يُحذف الـ Tombstone من الـ Remote نهائياً عندما:
